...
# Clinical
                      ...
                      tx.reinit.part.prob = c(0.00291, 0.00291, 0.00291,0.00291, 0.00291, 0.00291,0.00291, 0.00291, 0.00291),
...
#______________________________________________________________
## Cure
cure.time = c(200,201,202, 521,522,523, 750, 751, 752, 753, 800, 853, 854, 855, 856,
              1041, 1042, 1101, 1102, 1200, 1201, 1202, 1203,  1300, 1301, 1302,
              1400, 1401, 1402, 1561, 1562, 1563, 1702, 1703, 1704, 1852, 1853, 1854,
              2000, 2001, 2002,  2101, 2102, 2201, 2202, 2290, 2291, 2387,
              2388, 2489, 2490, 2491, 2492),
cure.time.msm = c(198,199, 518, 519, 520, 748, 749, 851, 852, 1039, 1040, 1099, 1100, 1198,
                  1199, 1298, 1299, 1398, 1399, 1560, 1701, 1850, 1851, 2099, 2100, 2287, 2288,
                  2289, 2486, 2487, 2488),
cure.time.w = c(524, 857),
prev.targ = round(c(.212, .163, .258, .064, .036, .045, .098, .056, .069)*(500000*.00517),0),
prev.surplus = 1.03,
#______________________________________________________________
##Calibration
inc.targ.south = 18.4,
