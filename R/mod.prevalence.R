...
prevalence_msm <- function(dat, at) {
  ...
  dat$epi$ir100K[at] <- ((sum(dat$epi$incid[max(1,(at-52)):at], na.rm = TRUE) / dat$epi$num[at]))*100000
  dat$epi$ir100K.M[at]  <- ((sum(dat$epi$incid.M[max(1,(at-52)):at], na.rm = TRUE) / sum(sex == 1, na.rm = TRUE)))*100000
  dat$epi$ir100K.F[at]  <- ((sum(dat$epi$incid.F[max(1,(at-52)):at], na.rm = TRUE) / sum(sex == 2, na.rm = TRUE)))*100000
  dat$epi$ir100K.B[at]  <- ((sum(dat$epi$incid.B[max(1,(at-52)):at], na.rm = TRUE) / sum(race == 1, na.rm = TRUE)))*100000
  dat$epi$ir100K.H[at]  <- ((sum(dat$epi$incid.H[max(1,(at-52)):at], na.rm = TRUE) / sum(race == 2, na.rm = TRUE)))*100000
  dat$epi$ir100K.W[at]  <- ((sum(dat$epi$incid.W[max(1,(at-52)):at], na.rm = TRUE) / sum(race == 3, na.rm = TRUE)))*100000
  dat$epi$ir100K.MSM[at]  <- ((sum(dat$epi$incid.W[max(1,(at-52)):at], na.rm = TRUE) / sum(msm == 1, na.rm = TRUE)))*100000
  ...
  dat$epi$cc.linked1m.B.m.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 4, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 4, na.rm = TRUE)
  dat$epi$cc.linked1m.H.m.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 5, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 5, na.rm = TRUE)
  dat$epi$cc.linked1m.W.m.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 6, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 6, na.rm = TRUE)
  dat$epi$cc.linked1m.B.f.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 7, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 7, na.rm = TRUE)
  dat$epi$cc.linked1m.H.f.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 8, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 8, na.rm = TRUE)
  dat$epi$cc.linked1m.W.f.het[at] <- sum(tx.init.time - diag.time <= 4 & diag.time >= 2200 & dem.cat == 9, na.rm = TRUE) /
                                    sum(diag.status == 1 & diag.time >= 2200 & dem.cat == 9, na.rm = TRUE)
...
#                                   sum(diag.status == 1 & diag.time >= 3380 & race == 3, na.rm = TRUE)
  ...
  dat$epi$cc.ART.cov.diagnosed[at] <- sum(tx.status == 1, na.rm = TRUE) /
    sum(diag.status == 1, na.rm = TRUE)

  dat$epi$cc.ART.cov.diagnosed.B.msm[at] <- sum(tx.status == 1 & dem.cat == 1, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 1, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.H.msm[at] <- sum(tx.status == 1 & dem.cat == 2, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 2, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.W.msm[at] <- sum(tx.status == 1 & dem.cat == 3, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 3, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.B.m.het[at] <- sum(tx.status == 1 & dem.cat == 4, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 4, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.H.m.het[at] <- sum(tx.status == 1 & dem.cat == 5, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 5, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.W.m.het[at] <- sum(tx.status == 1 & dem.cat == 6, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 6, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.B.f.het[at] <- sum(tx.status == 1 & dem.cat == 7, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 7, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.H.f.het[at] <- sum(tx.status == 1 & dem.cat == 8, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 8, na.rm = TRUE)
  dat$epi$cc.ART.cov.diagnosed.W.f.het[at] <- sum(tx.status == 1 & dem.cat == 9, na.rm = TRUE) /
    sum(diag.status == 1 & dem.cat == 9, na.rm = TRUE)
